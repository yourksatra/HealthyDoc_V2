                ...
                <div align="left" style="margin: 1rem calc(100rem/30);">
                    <table id="example" class="table table-striped table-bordered" style="width:100%">
                        <div style="margin-left: 2rem; margin-bottom:1rem;">
                            <a href="<?= "".base_url('authpetugas/inputPem?kdRM=')."".$kdRM.""?>" class="btn btn-info" style="margin-left: -2rem;">+ Input Data Baru</a>
                        </div>
                        <thead>
                            <tr>
                                <th>NIK</th>
                                                ...
                                                <div class='modal-dialog modal-dialog-centered modal-dialog-scrollable'>
                                                    <div class='modal-content'>
                                                        ...
                                                        <div class='modal-footer'>
                                                            ...
                                                            <a class='btn btn-info' href='".base_url('authpetugas/inputPem?kdRM=')."".$kdRM."'>+ Data baru</a> 
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                                            
